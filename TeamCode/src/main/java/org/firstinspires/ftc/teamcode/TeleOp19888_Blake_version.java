...
@TeleOp
public class TeleOp19888_Blake_version extends LinearOpMode {
    //declaring motors
    ...
    public void rotateClaw() {
        //Todo Fixing this code rn
        //suggestion: maybe change 0.1 to 0.01
            if (gamepad1.a) {
                servoClaw.setPosition(servoClaw.getPosition()+0.01);
            }else if (gamepad1.a) {
                servoClaw.setPosition(servoClaw.getPosition()-0.01);
            }else {
                servoClaw.setPosition(servoClaw.getPosition()+0);
            }
        }
        }